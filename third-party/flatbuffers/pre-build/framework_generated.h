...
#ifdef LITE_WITH_BAREMETAL
  const flatbuffers::Vector<int> *ints() const {
    return GetPointer<const flatbuffers::Vector<int> *>(VT_INTS);
  }
#else
...
#ifdef LITE_WITH_BAREMETAL
  void add_ints(flatbuffers::Offset<flatbuffers::Vector<int>> ints) {
...
#ifdef LITE_WITH_BAREMETAL
    flatbuffers::Offset<flatbuffers::Vector<int>> ints = 0,
#else    
...
#ifdef LITE_WITH_BAREMETAL
  auto ints__ = ints ? _fbb.CreateVector<int>(*ints) : 0;
#else  
