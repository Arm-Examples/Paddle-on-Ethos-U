...
def RescaleAttributeStart(builder): builder.StartObject(9)
...
def RescaleAttributeAddInputUnsigned(builder, inputUnsigned): builder.PrependBoolSlot(7, inputUnsigned, 0)
def RescaleAttributeAddOutputUnsigned(builder, outputUnsigned): builder.PrependBoolSlot(8, outputUnsigned, 0)
