...
def TosaTensorStart(builder): builder.StartObject(7)
...
def TosaTensorAddVariable(builder, variable): builder.PrependBoolSlot(4, variable, 0)
def TosaTensorAddIsUnranked(builder, isUnranked): builder.PrependBoolSlot(5, isUnranked, 0)
def TosaTensorAddVariableName(builder, variableName): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(variableName), 0)
