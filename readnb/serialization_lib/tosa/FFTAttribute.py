...
class FFTAttribute(object):
    ...
    @classmethod
    def GetRootAsFFTAttribute(cls, buf, offset):
...
def FFTAttributeStart(builder): builder.StartObject(2)
def FFTAttributeAddInverse(builder, inverse): builder.PrependBoolSlot(0, inverse, 0)
def FFTAttributeAddLocalBound(builder, localBound): builder.PrependBoolSlot(1, localBound, 0)
