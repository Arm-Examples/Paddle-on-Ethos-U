...
class AddVisitor_080_BI(NodeVisitor):
    ...
    def define_node(
        ...
        if output.dtype == ts.DType.INT8:
            ...
            rescale_output = tosa_graph.addIntermediate(broadcasted_shape, ts.DType.INT8)
        else:
        ...
        if output.dtype == ts.DType.INT8:
            ...
            # pyre-ignore
            tqutils.insert_rescale_op_to_int8(tosa_graph, add_output, scale_back, output_scale, rescale_output.name)
