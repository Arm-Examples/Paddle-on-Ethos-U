...
MESSAGE(STATUS "gcc cpu is  ${GCC_CPU}")
...
add_compile_options(
  -mcpu=${GCC_CPU} -mthumb "$<$<CONFIG:DEBUG>:-gdwarf-3>"
  "$<$<COMPILE_LANGUAGE:CXX>:-fno-unwind-tables;-fno-exceptions>"
  -fdata-sections -ffunction-sections
)
...
if(SEMIHOSTING)
  MESSAGE(STATUS "SEMIHOSTING")
  add_link_options(--specs=rdimon.specs)
else()
  MESSAGE(STATUS "Not SEMIHOSTING")
