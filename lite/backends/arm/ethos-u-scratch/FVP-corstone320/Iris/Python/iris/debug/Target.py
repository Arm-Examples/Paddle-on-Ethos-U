...
#
# \date   Copyright ARM Limited 2016-2024 All Rights Reserved.
...
class TargetBase(object):
    ...
    def add_event_callback(self, *args, **kwargs):
        # see SyncTarget and AsyncTarget for implementation
        raise NotImplementedError
    ...
    def disassemble(self, address, count = 1, mode = None, memory_space = None, attributes = {}):
        """
        ...
        :param attributes:
            Memory attributes (e.g. MECID) used when reading the opcode from memory. If
            unspecified, the default attributes for the memory space will be used.
    ...
    def add_bpt_prog(self, address, memory_space = None, dontStop = False):
        """
    ...
    def add_bpt_mem(self, address, memory_space = None, on_read = True, on_write = True, on_modify = None, dontStop = False):
        """
        ...
        try:
            bptId = self.client.irisCall().breakpoint_set(instId = self.instId, type = 'data',
                                                         address = address, spaceId = space.spaceId,
                                                         rwMode = rwMode, dontStop = dontStop)
        except iris.error.IrisError as e:
    ...
    def add_bpt_reg(self, reg_name, on_read = True, on_write = True, on_modify = None, dontStop = False):
        """
...
class AsyncTarget(TargetBase):
    ...
    def add_event_callback(self, event_name, func, fields=None, syncEc=False):
        """
        ...
        self._event_manager.add_callback(evSrcId, func, fields, syncEc)
...
class SyncTarget(TargetBase):
    ...
    def add_event_callback(self, event_name, func, fields=None, instId=None, syncEc=False):
        """
