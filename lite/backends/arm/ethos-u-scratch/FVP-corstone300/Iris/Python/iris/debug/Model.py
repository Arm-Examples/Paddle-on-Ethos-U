...
class ModelBase(object):
    ...
    def __init__(self, client, verbose):
        ...
        all_instance_infos = self.client.irisCall().instanceRegistry_getList(prefix = 'component')
    ...
    def get_global_instance(self):
        ...
        if 0 not in self.targets:
            instance_infos = iris.try_iris(self.client.irisCall().instanceRegistry_getList, [], prefix = 'framework')
            self.targets[0] = self._new_target([x for x in instance_infos if x.instId == 0][0])
