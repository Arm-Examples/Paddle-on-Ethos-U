...
# Arm config
if(LITE_WITH_ARM)
  set(ARM_TARGET_OS_LIST "android" "armlinux" "ios" "ios64" "armmacos" "qnx" "arm_baremetal")
  ...
  # Toolchain config
  if ((LITE_ON_TINY_PUBLISH OR LITE_WITH_LTO) AND NOT ARM_TARGET_OS STREQUAL "qnx" AND NOT ARM_TARGET_OS STREQUAL "arm_baremetal" )
  ...
  if(ARM_TARGET_OS STREQUAL "arm_baremetal")
    include(os/arm_baremetal)
  endif()
